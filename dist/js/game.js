var platforms; var players; var newEnemy;
...
window.onload = function() {
  ...
  function preload(){
    ...
    game.load.atlasJSONHash('enemy', 'assets/enemy.png', 'assets/enemy.json')
  }
  ...
  function create(){
    ...
    for (var i = 0; i<20; i++){
      var newEnemy = game.add.sprite(Math.random()*500, Math.random()*200, 'enemy')
      newEnemy.animations.add('run');
      newEnemy.animations.play('run', 60, true, true);
      game.physics.arcade.enable(newEnemy);
      newEnemy.body.bounce.y = Math.random()*1;
      newEnemy.body.gravity.y = 100;
  ...
  function update(){
    game.physics.arcade.collide(newEnemy, player);
    game.physics.arcade.collide(player, platforms);
    game.physics.arcade.overlap(player, platforms, newEnemy, null, this);
...
// //global variables
// window.onload = function () {
//   var game = new Phaser.Game(900, 900, Phaser.AUTO, 'testgame');
